...
# model 1 -----------------------------------------------------------------
file_m1 <- file.path(("code/experiments/exp1/model1_fixedsens.stan"))
...
# model 2
file_m2 <- file.path(("code/experiments/exp1/model2_fixedsens.stan"))
...
file_m3 <- file.path(("code/experiments/exp1/model3_fixedsens.stan"))
...
file_m4 <- file.path(("code/experiments/exp1/model4_fixedsens.stan"))
...
file_m5 <- file.path(("code/experiments/exp1/model5_fixedsens.stan"))
...
file_m6 <- file.path(("code/experiments/exp1/model6_fixedsens.stan"))
...
save(res_posterior_m1, res_posterior_m2,
     ...
     res_posterior_m5, res_posterior_m6, file=here("results/experiments/exp3/fixedsens.RData"))
