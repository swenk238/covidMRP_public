...
data {
  ...
  int postcode[n];           // postcode
  int strata[n];               // sampling strata
  vector[n] sex;                      // sex, 1=male, 0=female
  int agegp[n];                   // age group, 1=20-29, 2=30-39,3=40-49, 4=50-59, 5=60-69 
  vector<lower=1,upper=n_seifa>[n] seifa_cont;         // continuous seifa for linear term
  int seifa[n];                 // SEFIA decile, 1-10 
  ...
  int postcode_pop[J];       // poststratification cells, postcode
  int strata_pop[J];           // poststratification cells, strata
  int sex_pop[J];                     // poststratification cells, sex
  int agegp_pop[J];               // poststratification cells, agegp
  int seifa_pop[J];             // poststratification cells, SEIFA decile
