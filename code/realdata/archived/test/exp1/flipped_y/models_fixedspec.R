...
# model 1 -----------------------------------------------------------------
file_m1 <- file.path(("code/experiments/exp1/model1_fixedspec.stan"))
...
# model 2
file_m2 <- file.path(("code/experiments/exp1/model2_fixedspec.stan"))
...
file_m3 <- file.path(("code/experiments/exp1/model3_fixedspec.stan"))
...
file_m4 <- file.path(("code/experiments/exp1/model4_fixedspec.stan"))
...
file_m5 <- file.path(("code/experiments/exp1/model5_fixedspec.stan"))
...
file_m6 <- file.path(("code/experiments/exp1/model6_fixedspec.stan"))
...
save(res_posterior_m1, res_posterior_m2,
     ...
     res_posterior_m5, res_posterior_m6, file=here("results/experiments/exp3/fixedspec.RData"))
