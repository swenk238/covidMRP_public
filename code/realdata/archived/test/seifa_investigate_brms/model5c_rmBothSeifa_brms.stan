...
data {
  ...
  matrix[J, K] X_pop_5c; // poststrat design matrix
...
generated quantities {
    ...
    for (j in 1:J){
      mu_pop[j] += r_1_1[agegp_pop[j]] * Z_1_1[j] + r_2_1[postcode_pop[j]] * Z_2_1[j] + r_3_1[strata_pop[j]] * Z_3_1[j];
    }
    p_pop = inv_logit(mu_pop + X_pop_5c*b);
