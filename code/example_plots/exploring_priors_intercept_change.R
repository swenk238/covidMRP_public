...
prior = prior_string("normal(-3,1)", class = "Intercept")

fit_model <- map(model_formulas, function(x){ brm(x, family = bernoulli(link = "logit"), sample_prior = "only", data = df, backend = "cmdstanr", prior = prior)})
...
ggplot(predicted_probability_df %>%
  ...
  ggtitle("Intercept ~ N(-3,1)")+
  theme(plot.title = element_text(hjust = 0.5))

ggsave("code/example_plots/N_-3_1_prior_predicted_prob.png", width =15, height = 10, units = "cm")
...
ggsave("code/example_plots/N_-3_1_prior_predicted_accuracy.png", width =15, height = 10, units = "cm")
...
ggsave("code/example_plots/N_-3_1_prior_predicted_sensitivity.png", width =15, height = 10, units = "cm")
...
ggsave("code/example_plots/N_-3_1_prior_predicted_specificity.png", width =15, height = 10, units = "cm")
...
ggsave("code/example_plots/N_-3_1_prior_predicted_auc.png", width =15, height = 10, units = "cm")
